        ...
        private void Mostrar()
        {
            switch (this.keyword)
            {
                case TipoLlamada.Todas:
                    richTextBox.Text += this.centralita.GananciasPorTotal.ToString();
                    break;

                case TipoLlamada.Local:
                    richTextBox.Text += this.centralita.GananciasPorLocal.ToString();
                    break;

                case TipoLlamada.Provincial:
                    richTextBox.Text += this.centralita.GananciasPorProvincial;
                    break;
            }
        }
