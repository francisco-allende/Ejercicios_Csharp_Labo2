...
namespace Tp1_Generics
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if ((da + a1)) 
            {
                Console.WriteLine("Se ha agregado el item!!!"); //no aparece en el pdf pero debe mostrarse
            }
            da.Agregar(a2);
            da.Agregar(a3);
            if (!da.Agregar(a4))
            {
                Console.WriteLine("No se pudo agregar el item!!!"); //no aparece en el pdf pero debe mostrarse
            }
